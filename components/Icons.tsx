...
export const HomeIcon: React.FC<IconProps> = ({ className, fill = 'none', strokeWidth = 2 }) => (
  <svg className={className} width="24" height="24" viewBox="0 0 24 24" fill={fill} stroke="currentColor" strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round">
    <path d="m3 9 9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z" />
    <polyline points="9 22 9 12 15 12 15 22" />
  </svg>
);

export const ForYouIcon: React.FC<IconProps> = ({ className, fill = 'none' }) => (
  <svg className={className} width="24" height="24" viewBox="0 0 24 24" fill={fill} stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <rect x="3" y="6" width="18" height="12" rx="2" ry="2" />
    <path d="M10 10l5 2-5 2V10z" fill="currentColor" />
  </svg>
);

export const BookmarkIcon: React.FC<IconProps> = ({ className, fill = 'none' }) => (
  <svg className={className} width="24" height="24" viewBox="0 0 24 24" fill={fill} stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="M19 21l-7-4-7 4V5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2v16z" />
  </svg>
);

export const RewardIcon: React.FC<IconProps> = ({ className, fill = 'none' }) => (
  <svg className={className} width="24" height="24" viewBox="0 0 24 24" fill={fill} stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="M7 21h10" />
    <path d="M8 21v-3" />
    <path d="M16 21v-3" />
...
export const ProfileIcon: React.FC<IconProps> = ({ className, fill = 'none' }) => (
  <svg className={className} width="24" height="24" viewBox="0 0 24 24" fill={fill} stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
